...
class ListingController extends Controller
{
    ...
    {
        // Make sure current user is the owner of current listing
    ...
    {
        return view('listings.manage', ['listings' => auth()->user()->listings]);  //Pass the current user's listings to view
    }
}
