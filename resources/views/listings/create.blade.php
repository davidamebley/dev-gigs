    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form action="/listings" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title" placeholder="Example: Senior Full Stack Developer"/>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full"
                    name="location" placeholder="Example: Hybrid, Helsinki FI, etc"/>
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full"
                    name="tags" placeholder="Example: JavaScript, Backend, Postgres, etc"/>
            </div>
