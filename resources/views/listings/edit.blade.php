    ...
    <x-card class="p-10 max-w-lg mx-auto mt-24">
        ...
        <form action="/listings/{{$listing->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="title" placeholder="Example: Senior Full Stack Developer" value="{{ $listing->title }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full"
                    name="location" placeholder="Example: Hybrid, Helsinki FI, etc" value="{{ $listing->location }}" />
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full"
                    name="tags" placeholder="Example: JavaScript, Backend, Postgres, etc" value="{{ $listing->tags }}" />
            ...
            <div class="mb-6">
                ...
                <img class="w-48 mr-6 mb-6" src="{{$listing->logo ? asset('storage/'.$listing->logo) : asset('images/no-image.png')}}" alt="Job logo"/>
